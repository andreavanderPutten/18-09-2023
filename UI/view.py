...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._ddnazioni = ft.Dropdown(label="Nazione")
        self._txtNarchi = ft.TextField(label="Inserire il numero di archi che si vuole usare:")

        # button for the "creat graph" reply
        self.btn_graph = ft.ElevatedButton(text="Crea Grafo", on_click=self._controller.handle_graph)
        row1 = ft.Row([self._ddyear,self._ddnazioni, self._txtNarchi],
